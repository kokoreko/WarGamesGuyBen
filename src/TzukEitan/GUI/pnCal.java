 ...
 * 
 */
public class pnCal extends JPanel {
  ...
  private boolean isDayChoosen = false;
  /**
   * Construct a pnCal, starting with today.
   */
  pnCal() {
    super();
  ...
  /**
   * Construct a pnCal, given the leading days and the total days
   * 
   * @exception IllegalArgumentException
   *                If year out of range
   */
  pnCal(int year, int month, int today) {
    super();
  ...
  /** Compute which days to put where, in the pnCal panel */
...
//    if (isLeap(calendar.get(Calendar.YEAR)) && mm > 1)
  ...
  public void setDate(int yy, int mm, int dd) {
    // System.out.println("pnCal::setDate");
    this.yy = yy;
  ...
  public void setIsDayChoosen(boolean b){
	  isDayChoosen = b;
  }
